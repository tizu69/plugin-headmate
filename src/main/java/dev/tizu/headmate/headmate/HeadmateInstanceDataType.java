...
public class HeadmateInstanceDataType
	implements PersistentDataType<byte[], HeadmateInstance>
{
	...
	@Override
	public HeadmateInstance fromPrimitive(
		byte[] primitive,
		PersistentDataAdapterContext context
	) {
		...
		switch (bb.limit() / MAGIC_BYTE_LEN) {
			...
			default:
				throw new IllegalArgumentException(
					"Invalid byte array length, got " + bb.limit()
				);
		}
	}
}
